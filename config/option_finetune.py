...
def parse_args():
    ...
    parser.add_argument('--wd', '--weight_decay', default=1e-3, type=float,
                    ...
                    dest='weight_decay')
    parser.add_argument('--resume', default='ddmim/log/seed3407/version_31/checkpoints/epoch=48_val_loss=0.04_DDMIMV9.ckpt', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: none)')
    parser.add_argument('--lpresume', default='ddmim/log/seed3407/version_26/checkpoints/last.ckpt', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: none)')
