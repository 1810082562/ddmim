...
def parse_args():
    ...
    parser.add_argument('--wd', '--weight_decay', default=1e-3, type=float,
                    ...
                    dest='weight_decay')
    parser.add_argument('--resume', default='ddmim/log/seed1/version_254/checkpoints/epoch=41-step=844999.ckpt', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: none)')
    parser.add_argument('--lpresume', default='ddmim/log/seed1/version_255/checkpoints/last.ckpt', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: none)')
