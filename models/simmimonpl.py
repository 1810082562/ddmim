...
from ddmim.models.swinTransformerV2 import SwinTransformerV2
from ddmim.models.simmim import SimMIM,SwinTransformerV2ForSimMIM
from ddmim.models.maxvit import MaxViT
...
class SimMIMforpl(LightningModule):
    def __init__(
        self,
        *,
        image_size=224,
    ...
    def training_step(self, batch, batch_idx): #-> Union[int, Dict[str, Union[Tensor, Dict[str, Tensor]]]]:
        ...
        l_pos=torch.cosine_similarity(x_masked_cls,x_cls).unsqueeze(-1)
