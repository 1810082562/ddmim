...
class Classifierv7(pl.LightningModule):
    def __init__(self,
                 model=DDMIMV7,
                 resume=None,
        ...
        self.model=DDMIMV7.load_from_checkpoint(resume)
        ...
        self.mlp_head = nn.Sequential(
            ...
            nn.Linear(self.model.hparams.num_classes, int(self.model.hparams.num_classes/2)),
            nn.GELU(),
            nn.Linear(int(self.model.hparams.num_classes/2), num_classes),
        )
